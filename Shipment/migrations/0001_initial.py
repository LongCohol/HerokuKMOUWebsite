    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.CharField(choices=[('MARUBISHI', 'MARUBISHI'), ('SUNAMI', 'SUNAMI'), ('GOLTENS', 'GOLTENS'), ('KNK', 'KNK'), ('KSS', 'KSS'), ('POSSM', 'POSSM'), ('SHI OCEAN', 'SHI OCEAN'), ('STX', 'STX'), ('EUCO', 'EUCO'), ('이강공사', '이강공사'), ('SAEHAN', 'SAEHAN'), ('DAN MO', 'DAN MO'), ('KLCSM', 'KLCSM'), ('오션마린', '오션마린'), ('GLOVIS', 'GLOVIS'), ('CENTRA', 'CENTRA'), ('SEOYANG', 'SEOYANG'), ('CMSHIP', 'CMSHIP'), ('DORVAL', 'DORVAL'), ('INTERGIS', 'INTERGIS'), ('SUNRIO', 'SUNRIO'), ('FORTUNE WILL', 'FORTUNE WILL'), ('보성상사', '보성상사'), ('MAN', 'MAN'), ('GOWIN', 'GOWIN')], db_column='company', max_length=100, verbose_name='COMPANY')),
                ('vessel', models.CharField(blank=True, db_column='vessel', max_length=100, verbose_name='VESSEL')),
                ('by', models.CharField(blank=True, choices=[('AIR', 'AIR'), ('SEA', 'SEA'), ('DHL', 'DHL'), ('TNT', 'TNT'), ('SFX', 'SFX'), ('FDX', 'FDX')], db_column='by1', max_length=50, verbose_name='BY')),
                ...
                ('odr', models.TextField(db_column='odr', max_length=100, verbose_name='ODR')),
                ...
                ('in_date', models.DateField(blank=True, db_column='in1', max_length=10, null=True, verbose_name='IN')),
                ...
                ('flag_status', models.CharField(blank=True, choices=[('BLANK', 'BLANK'), ('COMPLETED', 'COMPLETED'), ('START', 'START'), ('STAY', 'STAY')], db_column='flg', max_length=10, verbose_name='STATE')),
